# Install the OpenCode Chinese management CLI on Windows x64.
param(
    [string]$Version = ""
)
...
$InstallDir = Join-Path $env:USERPROFILE ".opencode-i18n"
$BinDir = Join-Path $InstallDir "bin"
$ExePath = Join-Path $BinDir "opencode-cli.exe"
$AssetName = "opencode-cli-windows-amd64.exe"
